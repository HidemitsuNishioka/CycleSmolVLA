...
class BaseStrategyConfig(RolloutStrategyConfig):
    ...
    # Focused-terminal R key: restart inference without reconnecting hardware.
    # Disabled in command-prompt (--interactive) sessions, which own stdin.
    keyboard_restart: bool = False
